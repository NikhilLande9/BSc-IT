...
function DropdownProfile({
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        <img className="w-8 h-8 rounded-full" src="https://pics.craiyon.com/2024-09-27/BZQiWv_7TqOLH-p8K2AcIw.webp" width="32" height="32" alt="User" />
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium text-gray-600 group-hover:text-gray-800">Furqan Uchiha</span>
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200">
            <div className="font-medium text-gray-800">Furqan Uchiha</div>
