export default () => {
    ...
    return (
        <footer className="text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            <div className="max-w-lg flex flex-col items-center sm:mx-auto sm:text-center">
                <img
                ...
                <p className="leading-relaxed mt-2 text-[15px] text-center">
                    Connect, collaborate, and conquer your IT studies. Be part of our BSc IT community for shared notes and academic support.
                </p>
            </div>
