    ...
    const Brand = () => (
        <div className="flex items-center justify-between py-5 md:block">
            <a href="javascript:void(0)">
                <img
                    src="../src/assets/bscitoriginals.png"
                    width={120}
                    height={50}
                    alt="BSc IT logo"
                />
                    ...
                    <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
                        ...
                        <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
                            <ul className="flex-1 justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                                ...
                                <li>
                                    <a href="javascript:void(0)" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-violet-500 hover:bg-violet-400 active:bg-violet-600 duration-150 rounded-full md:inline-flex">
                                        Get start
            ...
            <section className="relative">
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center">
                        ...
                        A community of learners, empowering the next generation.
                        </p>
                        <form
                            ...
                            />
                            <button className="flex items-center justify-center gap-x-2 py-2.5 px-4 mt-3 w-full text-sm text-white font-medium bg-violet-600 hover:bg-violet-400 active:bg-violet-600 duration-150 rounded-lg sm:mt-0 sm:w-auto">
                                Get started
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                ...
                <div className="absolute inset-0 m-auto max-w-xs h-[357px] sm:max-w-md md:max-w-lg" ></div>
            </section>
        </div>
    )
}